...
namespace CapaEntidad.Financiero
{
    ...
    /// <summary>Tabla <c>financial_transaction_lines</c> del módulo financiero.</summary>
    [Table("financial_transaction_lines")]
    public class FinancialTransactionLine : ITieneIglesia
    {
        [Key]
        ...
        /// <summary>sedes.ID que soporta la línea</summary>
